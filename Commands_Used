...
make
This has been installed already on the cloud machine. No need to run this command.

Create $VTR_ROOT which points to where the vtr is downloaded from github


Day 1:
Launch AMD-Xilinx Vivado from the terminal on the desktop.
Type the command "vivado" on the terminal
...
$VTR_ROOT/vtr_flow/scripts/run_vtr_flow.py  $VTR_ROOT/doc/src/quickstart/counter.v    $VTR_ROOT/vtr_flow/arch/timing/EArch.xml   -temp_dir .   --route_chan_width 100 
...
$VTR_ROOT/vpr/vpr   $VTR_ROOT/vtr_flow/arch/timing/EArch.xml     counter --circuit_file < >/osfpga/SOFA/FPGA1212_QLSOFA_HD_PNR/FPGA1212_QLSOFA_HD_task/latest/vpr_arch/core/MIN_ROUTE_CHAN_WIDTH/core_yosys_out.blif    --route_chan_width 100   --analysis --disp on


interactive way with GUI:without --analysis option
$VTR_ROOT/vpr/vpr   $VTR_ROOT/vtr_flow/arch/timing/EArch.xml   counter --circuit_file counter.pre-vpr.blif  --route_chan_width 100    --disp on
-----------------------------------------------
timing analysis
...
$VTR_ROOT/vtr_flow/scripts/run_vtr_flow.py $VTR_ROOT/doc/src/quickstart/counter.v   $VTR_ROOT/vtr_flow/arch/timing/EArch.xml    -power -cmos_tech  < >/osfpga/vtr_github/vtr-verilog-to-routing/vtr_flow/tech/PTM_45nm/45nm.xml  -temp_dir .  --route_chan_width 100
...
Now run:
$VTR_ROOT/vpr/vpr    $VTR_ROOT/vtr_flow/arch/timing/EArch.xml     < >/osfpga/vtr_work/quickstart/counter_earch/counter_new.blif    --route_chan_width 100      --power --activity_file counter_activities.act --tech_properties $VTR_ROOT/vtr_flow/tech/PTM_45nm/45nm.xml
...
You will need to do the following on your own. We have not installed SOFA.
...
From here, do a "gh repo clone lnis-uofu/SOFA" or "git clone https://github.com/lnis-uofu/SOFA.git"
...
/////////////////////////
Commands needed for the workshop:
...
Source: https://github.com/nandithaec/fpga_workshop_collaterals
